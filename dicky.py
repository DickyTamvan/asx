...
def tokenz():
	...
	try:
		...
		logo()
		print("\n \033[0;97m[\033[0;93m*\033[0;97m] WELCOME)
...
def menu():
	...
	logo()
        print(" "+p+"["+K+"+"+M+"]ــــــــــــــــــــــــــــــــــــ")
	print(" "+p+"["+K+"+"+M+"] YourNama : "+H+K+" %s"%(nama))
	print(" "+p+"["+K+"+"+M+"]Your  ID   : "+K+id)
        print(" "+p+"["+K+"+"+M+"]ــــــــــــــــــــــــــــــــــــ")
        print(" "+p+"["+K+"+"+M+"] Your IP    : "+H+ip)
	print(" "+p+"["+K+"+"+M+"] Premium: "+H+"Yes "+P+"")
	print(" "+p+"["+K+"+"+M+"]ــــــــــــــــــــــــــــــــــــ ")
	print
	print("      [ Welcome To My Script "+H+""+P+"]")
	print
	print("      [ Choose "+H+""+P+"]")
	print(""+p+" "+B+"1 "+P+"> "+K+"Crack From Publik/Teman")
	print(" "+B+"2 "+P+"> "+K+"Crack From Followers")
	print(" "+B+"3 "+P+"> "+K+"Crack From Postingan")
	print(" "+B+"4 "+P+"> "+K+"Open Result Crack")
	print(" "+B+"5 "+P+"> "+K+"Setting User-Agents")
	print(" "+B+"6 "+P+"> "+K+"Check INFO Facebook")
	print(" "+B+"7 "+P+"> "+M+"Go Out........ "+M+"")
	print
